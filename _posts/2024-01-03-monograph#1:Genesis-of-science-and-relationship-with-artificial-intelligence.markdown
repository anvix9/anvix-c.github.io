...
- <strong>[Monograph #1: Genesis of Science and relationship with AI.]({% post_url 2024-01-03-monograph#1:Genesis-of-science-and-relationship-with-artificial-intelligence %})</strong>
- [Monograph #2: Representations – Far from Reality, Yet So Close Ever…]({% post_url 2024-02-26-monograph#2:Representations-far-from-reality-yet-so-close-ever  %})
